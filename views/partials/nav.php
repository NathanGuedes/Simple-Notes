            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/about"
                           class="<?= isCurrentPage('/about') ? "rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" : "rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white"?>">About</a>
                        <a href="/notes"
                        ...
                        <a href="/contact"
                           class="<?= isCurrentPage('/contact') ? "rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" : "rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white"?>">Contact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
