...
<?php require base_path('views/partials/banner.php') ?>
    ...
    <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <form method="POST" class="mt-10" action="/note">
                <input type="hidden" name="_method" value="PATCH">
                <input type="hidden" name="id" value="<?= $note['id']?>">
                <div class="relative mb-6">
                    <div class="flex">
                        <div class="relative w-full">
                            <label for="body" class="flex  items-center mb-2 text-gray-600 text-sx font-medium">Body
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="/notes" class="w-full h-12 bg-red-400 hover:bg-red-500 transition-all duration-700 rounded-full shadow-xs text-white text-base font-semibold leading-6 flex items-center justify-center">Cancel</a>
                </div>
            </form>
        </div>
    </main>
